defmodule CPAP.Web.AuthTest do
  ...
  setup %{conn: conn} do
    conn =
    conn
    |> bypass_through(CPAP.Web.Router, :browser)
    |> get("/")
  ...
  test "authenticate_user continues with current_user exists", %{conn: conn} do
    conn =
    conn
    |> assign(:current_user, %CPAP.User{})
